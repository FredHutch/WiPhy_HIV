...
//#other cell/virus parameters
	...
	double dA_density;	// exponent for density dependent death rate (cabn be used with all immune models except da_ic50 & lifespan_decay)
...
// variables for data file writing
	...
	double time;
	double start_time; // used to reset time post-ATI to fit post-ATI peak time etc.
