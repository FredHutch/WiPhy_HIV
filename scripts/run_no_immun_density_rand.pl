...
my $low_dA_density=1;
my $high_dA_density=1.3;
my $range_dA_density= $high_dA_density-$low_dA_density;
...
while ( $count > 0 ){
    ...
    my $new_dA_density= $range_dA_density*rand() + $low_dA_density;
